...
export { default as TextDecoration } from "../components/shared/text/decoration.svelte";
export { default as TextDetail } from "../components/shared/text/detail.svelte";
export { default as TextLarge } from "../components/shared/text/lg.svelte";
export { default as TextSmall } from "../components/shared/text/sm.svelte";
export { default as TextXL } from "../components/shared/text/xl.svelte";
